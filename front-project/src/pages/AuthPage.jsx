    ...
    try {
      if (mode === 'login') {
        ...
        if (role === 'doctor') {
          ...
          // Patient register
          const { specialization, professionalDescription, stateCertificateNumber, ...patientPayload } = formData;
          ...
          {mode === 'register' && (
            <>
              ...
              <FormGroup>
                ...
                <Input required type="tel" name="phoneNumber" value={formData.phoneNumber} onChange={handleInputChange} placeholder="+1 234 567 890" />
              </FormGroup>
              ...
              {role === 'doctor' && (
                <>
                  <FormGroup>
                    ...
                    <Input required name="specialization" value={formData.specialization} onChange={handleInputChange} placeholder="Cardiologist" />
                  </FormGroup>
                  <FormGroup>
